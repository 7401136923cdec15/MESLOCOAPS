...
public class APSTaskStepPlan implements Serializable {
	...
	public Calendar RealStartTime = Calendar.getInstance();
	public Calendar RealEndTime = Calendar.getInstance();
	...
	public Calendar getRealStartTime() {
	...
	public void setRealStartTime(Calendar realStartTime) {
