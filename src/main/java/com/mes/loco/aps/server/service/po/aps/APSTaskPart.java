...
public class APSTaskPart implements Serializable {
	...
	public int PointFinishSize = 0;

	/**
	 * 日计划排程结果
	 */
	public List<APSTaskPart> StepPlanList = new ArrayList<APSTaskPart>();

	public int RealPartID = 0;
	...
	public APSTaskPart(int iD, int orderID, String partNo, int workShopID, int lineID, int partID, int shiftID,
			int planerID, int shiftPeriod, Calendar submitTime, Calendar startTime, Calendar endTime, String orderNo,
			int priority, String planerName, int active, int status, Calendar shiftDate, int customerID, String wBSNO,
			int routeID, int auditID, String auditor) {
		super();
		ID = iD;
		OrderID = orderID;
		PartNo = partNo;
	...
	public int getPointFinishSize() {
		return PointFinishSize;
	}
	...
	public void setPointFinishSize(int pointFinishSize) {
		PointFinishSize = pointFinishSize;
	}
	...
	public List<APSTaskPart> getStepPlanList() {
		return StepPlanList;
	}

	public void setStepPlanList(List<APSTaskPart> stepPlanList) {
		StepPlanList = stepPlanList;
	}

	public int getRealPartID() {
		return RealPartID;
	}

	public void setRealPartID(int realPartID) {
		RealPartID = realPartID;
	}
}
