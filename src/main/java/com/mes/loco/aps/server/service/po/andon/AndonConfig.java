 ...
 * 
 * @author YouWang·Peng
 * @CreateTime 2021-6-23 10:18:25
 */
public class AndonConfig implements Serializable {
	...
	public void setNcrExcFlag(int ncrExcFlag) {
		NcrExcFlag = ncrExcFlag;
	}
